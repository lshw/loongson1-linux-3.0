...
static const u8 cx_sensor_init[][4] = {
	{0x88, 0x11, 0x01, 0x01},
	{0x88, 0x12, 0x70, 0x01},
	{0x88, 0x0f, 0x00, 0x01},
	{0x88, 0x05, 0x01, 0x01},
...
static const u8 reg20[] = { 0x10, 0x42, 0x81, 0x19, 0xd3, 0xff, 0xa7, 0xff };
static const u8 reg28[] = { 0x87, 0x00, 0x87, 0x00, 0x8f, 0xff, 0xea, 0xff };
static const u8 reg10[] = { 0xb1, 0xb1 };
static const u8 reg71a[] = { 0x08, 0x18, 0x0a, 0x1e };		/* 640 */
static const u8 reg71b[] = { 0x04, 0x0c, 0x05, 0x0f };
	/* 352{0x04,0x0a,0x06,0x12}; //352{0x05,0x0e,0x06,0x11}; //352 */
static const u8 reg71c[] = { 0x02, 0x07, 0x03, 0x09 };
					/* 320{0x04,0x0c,0x05,0x0f}; //320 */
static const u8 reg71d[] = { 0x02, 0x07, 0x03, 0x09 };		/* 176 */
static const u8 reg7b[] = { 0x00, 0xff, 0x00, 0xff, 0x00, 0xff };

static void cx_sensor(struct gspca_dev *gspca_dev)
{
	int i = 0;
	int length;
	const u8 *ptsensor = cxsensor;
...
{
	const u8 *cxinit;
	static const u8 reg12[] = { 0x08, 0x05, 0x07, 0x04, 0x24 };
	static const u8 reg17[] =
...
static const u8 cx_jpeg_init[][8] = {
...
static const u8 cxjpeg_qtable[][8] = {
...
static const u8 reg12[] = { 0x0a, 0x05, 0x07, 0x04, 0x19 };
static const u8 regE5_8[] =
		{ 0x88, 0x00, 0xd4, 0x01, 0x88, 0x01, 0x01, 0x01 };
static const u8 regE5a[] = { 0x88, 0x0a, 0x0c, 0x01 };
static const u8 regE5b[] = { 0x88, 0x0b, 0x12, 0x01 };
static const u8 regE5c[] = { 0x88, 0x05, 0x01, 0x01 };
static const u8 reg51[] = { 0x77, 0x03 };
#define reg70 0x03
...
{
	struct sd *sd = (struct sd *) gspca_dev;
	u8 regE5cbx[] = { 0x88, 0x00, 0xd4, 0x01, 0x88, 0x01, 0x01, 0x01 };
	u8 reg51c[2];
	u8 bright;
	u8 colors;
...
{
	struct sd *sd = (struct sd *) gspca_dev;
	u8 regE5acx[] = { 0x88, 0x0a, 0x0c, 0x01 };	/* seem MSB */
/*	u8 regE5bcx[] = { 0x88, 0x0b, 0x12, 0x01};	 * LSB */
	u8 reg51c[2];
