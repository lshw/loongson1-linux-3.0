...
#define ___ALIGN(data, reg_field)	(((UINT32) (data)) << __START(reg_field))
...
( \
	___ALIGN(__MASK(reg##_##field), reg##_##field) \
)
...
( \
	((UINT32) (data) & ~___ALIGN(__MASK(reg##_##field), reg##_##field)) \
		| \
	___ALIGN((UINT32) (value) & __MASK(reg##_##field), reg##_##field) \
)
...
( \
	((UINT32) (data) & ~___ALIGN(__MASK(reg##_##field), reg##_##field)) \
		| \
	___ALIGN(reg##_##field##_##value & __MASK(reg##_##field), reg##_##field) \
)
