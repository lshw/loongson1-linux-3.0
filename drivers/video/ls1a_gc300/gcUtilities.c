...
UINT32 printSelectMenu(void)
{
	...
	printk("Select which test you want to run:\n");
	printk("0  - clear!\n");
	printk("1  - random clear!\n");
	printk("2  - line!\n");
	printk("3  - random line!\n");
	printk("4  - stretch!\n");
	printk("5  - random stretch!\n");
	printk("6  - mono expansion!\n");
	printk("7  - random mono expansion!\n");	
	printk("8  - random masked blit!\n");	
	printk("9  - filter blit! \n");
	printk("10 - filter blit formats! \n");
	printk("11 - rotation blit!\n");
	printk("99 - random tests! \n");
