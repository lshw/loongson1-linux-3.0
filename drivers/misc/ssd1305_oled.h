#ifndef _SSD1305LCD_H
#define _SSD1305LCD_H

#define SSD1305LCD_MINOR		156

#define SSD1305LCD_CLEAR		0x01			//清屏？
#define SSD1305LCD_SENDCTRL		0x02		//发送Ctrl
#define SSD1305LCD_SETSHORTDELAY	0x03	//SET短暂的延迟
#define SSD1305LCD_SETLONGDELAY	0x04		//SET长延迟
#define SSD1305LCD_REST			0x05
#define SSD1305LCD_WRITE_DOT	0x06
#define SSD1305LCD_LINE			0x07
#define SSD1305LCD_RECTANGLE	0x08
#define SSD1305LCD_CIRCLE		0x09
#define SET_PRINT_MODE			0x0a
#define PUT_CHAR					0x0b

#define LSLCD_IOC_MAGIC	'k'

#define LSLCD_SENDCTRL	_IOW(LSLCD_IOC_MAGIC, 0, int)
#define LSLCD_REST		_IOW(LSLCD_IOC_MAGIC, 5, int)

#define LSLCD_IOC_MAXNR	6


#define LCD_X_MAX			131				//屏幕的X轴的物理宽度
#define LCD_Y_MAX			63				//屏幕的Y轴的物理宽度
...
#define LCD_DIS_CIRCLE		0				//定义是否需要绘制圆形的功能
...
unsigned char Asii0610[] = 
{
//--  MS Gothic8;  此字体下对应的点阵为：宽x高=6x10   --
//--  宽度不是8的倍数，现调整为：宽度x高度=8x10  --
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,//1
0x00,0x40,0x40,0x40,0x40,0x40,0x00,0x60,0x00,0x00,//2
0xA0,0xA0,0xA0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,//3
0x00,0x28,0x28,0xFC,0x50,0xFC,0x50,0x50,0x00,0x00,//4
0x20,0x70,0xA8,0xA0,0x70,0x28,0xA8,0x70,0x20,0x00,//5
0x00,0xC8,0xD0,0xD0,0x20,0x58,0x58,0x98,0x00,0x00,//6
0x00,0x20,0x50,0x20,0x60,0x98,0x90,0x68,0x00,0x00,//7
0x40,0x40,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,//8
0x10,0x20,0x40,0x40,0x40,0x40,0x40,0x20,0x10,0x00,//9
0x80,0x40,0x20,0x20,0x20,0x20,0x20,0x40,0x80,0x00,//10

};


unsigned char Asii0816[] = 
{
...
static unsigned char Ascii_1[241][5]={		// Refer to "Times New Roman" Font Database...
						//   Basic Characters
